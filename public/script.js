...
(function () {
  ...
  function setupScreenMenu(menuToggle, sidebarMenu, closeMenu, navEntrar, navRegistrar, navModoClaro, navModoEscuro, fromScreen, toLoginScreen, toRegisterScreen) {
    safe(menuToggle, el => {
      el.addEventListener('click', () => {
        if (sidebarMenu) sidebarMenu.classList.add('active');
      });
  ...
  setupScreenMenu(loginMenuToggle, loginSidebarMenu, loginCloseMenu, $('login-nav-entrar'), $('login-nav-registrar'), $('login-nav-theme-toggle'), null, loginScreen, loginScreen, registerScreen);
  setupScreenMenu(registerMenuToggle, registerSidebarMenu, registerCloseMenu, $('register-nav-entrar'), $('register-nav-registrar'), $('register-nav-theme-toggle'), null, registerScreen, loginScreen, registerScreen);
  setupScreenMenu(forgotMenuToggle, forgotSidebarMenu, forgotCloseMenu, $('forgot-nav-entrar'), $('forgot-nav-registrar'), $('forgot-nav-theme-toggle'), null, forgotPasswordScreen, loginScreen, registerScreen);
  setupScreenMenu(resetMenuToggle, resetSidebarMenu, resetCloseMenu, $('reset-nav-entrar'), $('reset-nav-registrar'), $('reset-nav-theme-toggle'), null, resetPasswordScreen, loginScreen, registerScreen);
