...
// ---------------------------------------------------------------------------
// 1) E-MAIL DE REDEFINIÇÃO DE SENHA (ATUALIZADO)
// ---------------------------------------------------------------------------
exports.sendPasswordResetEmail = async (user, resetURL) => {
    const subject = 'Redefinição de Senha - Card YXS';
    const message = `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #000; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
            
            <!-- Header -->
            <div style="background-color: #041E42; color: #ffffff; padding: 20px; text-align: center; border-bottom: 5px solid #000;">
                <h1 style="margin: 0; font-size: 24px; font-weight: bold;">Card YXS</h1>
            </div>
            
            <!-- Body -->
            <div style="padding: 30px; text-align: center;">
                <h2 style="color: #041E42; margin-top: 0;">Redefinição de Senha</h2>
                ...
                <!-- Botão -->
                <a href="${resetURL}" style="display: inline-block; background-color: #3C1053; color: #ffffff; text-decoration: none; padding: 12px 25px; margin: 25px 0; border-radius: 5px; font-weight: bold; font-size: 16px;">
                    REDEFINIR MINHA SENHA
                </a>
                
                <p style="font-size: 14px; color: #777;">Este link é válido por apenas 1 hora.</p>
                <p style="font-size: 14px; color: #777;">Se você não solicitou esta redefinição, por favor, ignore este e-mail.</p>
            </div>
...
// ---------------------------------------------------------------------------
// 2) CONFIRMAÇÃO DE REDEFINIÇÃO DE SENHA (PADRONIZADO)
// ---------------------------------------------------------------------------
...
// ---------------------------------------------------------------------------
// 3) E-MAIL DE BOAS-VINDAS (ATUALIZADO)
// ---------------------------------------------------------------------------
exports.sendWelcomeEmail = async (user) => {
    ...
    const message = `
        <div style="font-family: Arial, sans-serif; line-height: 1.6; color: #000; max-width: 600px; margin: 0 auto; border: 1px solid #ddd; border-radius: 8px; overflow: hidden;">
            ...
            <!-- Body -->
            <div style="padding: 30px; text-align: center;">
                <h2 style="color: #041E42; margin-top: 0;">Sua conta foi criada com sucesso!</h2>
                <p style="font-size: 16px;">Olá ${user.username},</p>
                ...
                <p style="font-size: 14px; color: #777;">Se precisar de ajuda, nossa equipe está à disposição.</p>
            </div>

            <!-- Footer -->
            <div style="background-color: #f4f4f4; color: #999; padding: 15px; text-align: center; font-size: 12px;">
                <p style="margin: 0;">Atenciosamente,</p>
                <p style="margin: 0;">Equipe Card YXS</p>
            </div>
        </div>
    `;
